...
public class SoslQueryProcessor {
    ...
    public static ResultSet processQuery(ForcePreparedStatement forcePreparedStatement, String soqlQuery, PartnerService partnerService, SoslQueryAnalyzer soslQueryAnalyzer) {
        return null;
    }
